...
public class OrderLine {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.actioncode, orderLine.actioncode)
				...
				&& Objects.equals(this.shipsetid, orderLine.shipsetid) && Objects.equals(this.shipto, orderLine.shipto)
	...
	@Override
	public int hashCode() {
		return Objects.hash(actioncode, attributes, bandagworkordernumber, bookedflag, calculatepriceflag,
				cancelcomments, cancelledflag, cancelledquantity, carrierquotedfreightcost, changereason, claimnumber,
				consumerfreighthandling, consumersalesprice, consumersalestax, context, contractnumber,
				couponcodediscount, createdby, creationdate, customerReservedQty, customeritemnetprice,
				customerlinenumber, customerorderlinenumber, customerordernumber, customerpartnumber, custpolinenumber,
				custponumber, dealerSoldTo, deliverto, delivertoorgid, deliveryleadtime, dotnumber, edigtin,
				expectedresvqty, fetexemption, flowstatuscode, fobpointcode, fobpointmeaning, freightamount,
				freightcarriercode, freightcarriermeaning, freighttermscode, freighttermsmeaning, fulfillmentmethod,
				headerid, holdflag, holdnamedff, inventoryitemid, invoiceto, invoicetoorgid, isoline, isoordernumber,
				itemnumber, lastupdatedate, lastupdatedby, latestacceptabledate, linecategorycode, lineid, linenumber,
				linetypecode, linetypeid, linetypemeaning, mileage, naprogramnumber, openflag, orderedquantity,
				ordernumber, orderquantityuom, orderunitofmeasure, orgid, origsysdocumentref, origsyslineref,
				packinginstructions, paymenttermid, paymenttermmeaning, paymenttypecode, paymenttypemeaning,
				pickupDcOrgId, poxshipflag, poxshipnotes, pricelistid, pricelistname, pricingdate, prioritypickup,
				processeddate, processedmessage, processflag, producttype, promiseddate, reason, referenceheaderid,
				referencelineid, referencetype, restockingfee, returnattribute1, returnattribute2, returncontext,
				returnreasoncode, route, routesequence, salesperson, salesrepid, schedulearrivaldate, scheduledshipdate,
				shipfrom, shipfromorgid, shipmentprioritycode, shipmentprioritymeaning, shippedquantity,
				shippingDcOrgId, shippinginstructions, shippingmethodcode, shippingmethodmeaning, shipsetid, shipto,
				shiptoorgid, soldfrom, soldfromorgid, soldto, soldtoorgid, subinventory, tppcostperunit, treaddepth,
				unitlistprice, unitsellingprice, updateflag, useritemdescription, vendorlocation, vendorname);
	}
